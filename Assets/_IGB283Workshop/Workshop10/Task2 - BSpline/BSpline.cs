...
namespace ScottBarley.IGB283.Assessment2.WS10
{
    /// <summary>
    /// Scott Barley 01/10/25
    /// Based on IGB382 Workshop Handout Week 10
    /// 
    /// DOSE: Generates and visualises an interactive B-Spline curve in Unity using De Boor’s algorithm.
    ///     The script dynamically constructs control points, calculates spline positions based on a knot vector,
    ///     and renders the resulting curve with a LineRenderer. Users can add, remove, or move control points in real time,
    ///     allowing for intuitive exploration of B-Spline geometry and behaviour.
    ///
    /// More Info:
    /// De Boor's Algorithm - 
